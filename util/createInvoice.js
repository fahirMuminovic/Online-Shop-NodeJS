...
function generateHeader(doc) {
	doc.image('data/logo/logo.png', 50, 45, { width: 50 })
		.fillColor('#444444')
		.fontSize(20)
		.text('Shop Inc.', 110, 57)
		.fontSize(10)
		.text('Shop Inc.', 200, 50, { align: 'right' })
		.text('Vrabanja 1', 200, 65, { align: 'right' })
		.text('Sarajevo, BiH, 71000', 200, 80, { align: 'right' })
		.moveDown();
}
...
function generateInvoiceTable(doc, invoice) {
	...
	for (i = 0; i < invoice.items.length; i++) {
		...
		generateTableRow(
			...
			item.productData.description.slice(0, 20),
